const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5604473&appid=e518782e81957a2dcf5d4fb87ea26f8d&units=imperial";
fetch(apiURL)
...
const apiURLforecast = "https://api.openweathermap.org/data/2.5/forecast?id=5604473&appid=e518782e81957a2dcf5d4fb87ea26f8d&units=imperial";
...
fetch(requestURL)
    ...
    .then(function(jsonObject){
        ...
        for (let i = 0; i< jsonObject.towns[6].events.length; i++) {
          let event = document.createElement('li');
          event.textContent = jsonObject.towns[6].events[i];
